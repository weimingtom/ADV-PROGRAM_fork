...
bool MainMenu::init()
{
	...
	buttonNew->setPosition(Vec2(900, visibleSize.height - 243));
	...
	buttonLoad->setPosition(Vec2(900, visibleSize.height - 293));

	auto buttonCG = MenuItemImage::create("ui/Title/button_cg.png", "ui/Title/button_cg_down.png");
	buttonCG->setPosition(Vec2(900, visibleSize.height - 343));
	...
	buttonConfig->setPosition(Vec2(900, visibleSize.height - 393));
